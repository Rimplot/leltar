...
<?php echo form_open('storages/add'); ?>
...
<div class="row">
    <div class="col-lg-4 offset-lg-1">
        ...
        <div class="form-group<?php echo (form_error('address')) ? ' has-danger' : '' ?>">
            ...
            <input type="text" class="form-control<?php echo (form_error('address')) ? ' is-invalid' : '' ?>" name="address" value="<?php echo set_value('address'); ?>">
